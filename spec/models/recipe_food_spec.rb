...
RSpec.describe RecipeFood, type: :model do
  it 'valid if quantity is present' do
    ...
    @recipe = @user.recipes.create(name: 'Chapo', preparation_time: '2000-01-01 02:00:00 UTC hours', cooking_time: '2000-01-01 02:00:00 UTC hours', description: 'new testts',
                                   public: true)
